...
public class ServiceManagementServiceImpl implements ServiceManagementService {
    ...
    public ServiceDTO createService(ServiceDTO serviceDTO) {
        ...
        Service service = Service.builder()
                ...
                .serviceType(Service.ServiceType.valueOf(serviceDTO.getServiceType().toUpperCase()))
                .isActive(true)
                .build();
    ...
    public List<ServiceDTO> getServicesByType(String serviceType) {
        return serviceRepository.findByServiceType(Service.ServiceType.valueOf(serviceType.toUpperCase()))
                .stream()
                .map(this::convertToServiceDTO)
                .collect(Collectors.toList());
    }
